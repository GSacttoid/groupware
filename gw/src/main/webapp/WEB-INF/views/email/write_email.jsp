						...
						<form id="frm" method="post" enctype="multipart/form-data" autocomplete="off">
							...
							<table style="border:1px solid #d5d5d5;">
								...
								<tr>
									...
									<td class="flex flex-justify" colspan="3" style="border:1px solid #d5d5d5; cursor: pointer;">
										<input type="text" name="sn_title" class="input-100" maxlength="50" placeholder="메일주소사이에 ,(콤마) 또는 ;(세미콜론)으로 구분하여 입력하세요." />

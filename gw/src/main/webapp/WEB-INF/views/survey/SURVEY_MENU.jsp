...
<div class="menu-wrap">
    ...
    <div id="menu-icon" class="menu-icon active-menu"><a href="${pageContext.request.contextPath}/survey/main" title="survey"><i class="fas fa-vote-yea"></i><p>설문조사</p></a></div>
    ...
    <div id="menu-icon" class="menu-icon"><a href="${pageContext.request.contextPath}/address/main" title="address"><i class="fas fa-address-book"></i><p>인사관리</p></a></div>

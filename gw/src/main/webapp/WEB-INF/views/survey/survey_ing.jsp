			        ...
			        <div class="p20">
			        	<div class="flex flex-justify" style="line-height:center;">
			   	            <div class="notice-title font16 noto">
	                            <h3><i class="fas fa-book m-lr5"></i> 진행중인 설문조사 [전체]</h3>
	                        </div>
				            <div>
			                    ...
			                    <c:forEach var="survey_ing" items="${list}" varStatus="status">
				                    <tr>
				                        ...
				                        <td>
				                        	...
				                        	onClick="survey_form('${survey_ing.survey_id}','${survey_ing.survey_status}','${survey_ing.survey_view}','${survey_ing.survey_buseo}','${survey_ing.survey_grade}');">${survey_ing.survey_title}</div>
				                        </td>
				                        ...
				                        <c:if test = "${sessionScope.empId != null && sessionScope.empAuth > 9}">
					                        <td>
					                        	<button class="s-btn-red f6" id="deleteSurvey" 

...
<div class="menu-wrap">
    ...
    <div id="menu-icon" class="menu-icon active-menu"><a href="${pageContext.request.contextPath}/project/main" title="Project"><i class="fas fa-project-diagram"></i><p>프로젝트</p></a></div>

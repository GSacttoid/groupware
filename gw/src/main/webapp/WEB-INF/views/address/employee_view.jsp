						...
						<div class="page-main-wrap">
							<div class="title m-lr3">
								<h2 class="font18 noto m-t10 m-b5 tomato" style="color:tomato;">
									<i class="fas fa-feather-alt"></i> 사원정보 - [[아이디: ${list.emp_id}]]
								</h2>
							</div>
								...
								<div class="page-content">
									<form method="post" id="frm" name="frm" enctype="multipart/form-data">
											...
											<div class="member-right w-100 m-lr10" >
												<table>
													<tr class="tr-35">
														...
														<td class="td-13 p-lr3">
															<input type="text" autocomplete="off" name="emp_enter" id="emp_enter" class="input-135" readonly value="${list.emp_enter}" 
														...
														<td class="td-13 p-lr3">
															<input type="text" name="emp_pwd" id="emp_pwd" class="input-135" value="****" readonly maxlength="20" />
														</td>
													</tr>
													...
													<tr class="tr-35">
														...
														<td class="td-13 p-lr3">
															<input type="text" name="emp_name" id="emp_name" class="input-75" readonly value="${list.emp_name}" />
														...
														<td class="td-13 p-lr3">
															<input type="text" name="emp_birth" id="emp_birth" class="input-135 noto" readonly value="${list.emp_birth}" 
														...
														<td class="td-13 p-lr3">
															<input type="text" name="emp_phone" id="emp_phone" class="input-135" readonly value="${list.emp_phone}" maxlength="13"/>
														</td>
														<td class="td-7 center under bg-gray noto weight700">내선번호</td>
														<td class="td-13 p-lr3">
															<input type="text" name="emp_company_tel" id="emp_company_tel" class="input-135" readonly value="${list.emp_company_tel}" maxlength="13" />
														</td>
														<td class="td-7 center under bg-gray noto weight700">Tel</td>
														<td class="td-13 p-lr3">
															<input type="text" name="emp_tel" id="emp_tel" class="input-135" readonly value="${list.emp_tel}" maxlength="13" />
														</td>
													</tr>
													...
													<tr class="tr-35">
														...
														<td class="td-13 p-lr3">
															<input type="text" name="emp_height" id="emp_height" class="input-135" readonly value="${list.emp_height}" />
														</td>
														<td class="td-7 center under bg-gray noto weight700">몸무게</td>
														<td class="td-13 p-lr3">
															<input type="text" name="emp_weight" id="emp_weight" class="input-135" readonly value="${list.emp_weight}" />
														</td>
														<td class="td-7 center under bg-gray noto weight700">취미</td>
														<td class="td-13 p-lr3">
															<input type="text" name="emp_hobby" id="emp_hobby" class="input-135" maxlength="20" readonly value="${list.emp_hobby}" />
														</td>
														<td class="td-7 center under bg-gray noto weight700">특기</td>
														<td class="td-13 p-lr3">
															<input type="text" name="emp_speciality" id="emp_speciality" class="input-135" maxlength="20" readonly value="${list.emp_speciality}" />
														</td>
													...
													<tr class="tr-35">
														...
														<td class="td-13 p-lr3" colspan="9" >
															<input type="text" name="emp_license" id="emp_license" class="input-100" maxlength="20" readonly value="${list.emp_license}" />
														</td>
													</tr>
													...
													<tr class="tr-35">
														<td class="td-7 center under bg-gray noto weight700">어학사항
															1</td>
														<td class="td-13 p-lr3" colspan="9">
															<input type="text" name="emp_lang" id="emp_lang" class="input-100" maxlength="20" readonly value="${list.emp_lang}" />
														</td>
													</tr>
												</table>
											</div>
										...
										<div class="comment">
											...
											<textarea name="emp_comment" id="editor" class="noto" readonly 

...
<div class="menu-wrap">
    ...
    <div id="menu-icon" class="menu-icon active-menu"><a href="${pageContext.request.contextPath}/address/main" title="address"><i class="fas fa-address-book"></i><p>주소록</p></a></div>

						...
						<hr />
							...
							<div class="p10" style="border: 1px solid #c1c1c1;">
									...
									<div class="flex flex-justify">
										...
										<div class="">
											<form method="post" action="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}">
			                    	...
			                    	<div class="page-grp center m-t10">
			                         	<c:choose>
			                               	<c:when test = "${curPage > 1}">
												<span class="page">
			                                     	<a href="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}&curPage=1"><i class="fas fa-angle-double-left"></i></a>
			                                 	</span>
			                             	</c:when>
			                             	<c:otherwise>
			                                	<span class="page">
			                             ...
			                             <c:choose>
			                               	<c:when test = "${curPage > 1}">
			                               		<span class="page">
			                                    	<a href="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}&?curPage=${curPage-1}"><i class="fas fa-angle-left"></i></a>
			                                	</span>
			                               	</c:when>
			                             	<c:otherwise>
				                               	<span class="page">
			                           	...
			                           	<c:forEach begin="${blockBegin}" end ="${blockEnd}" var="num">
			                           		<c:if test="${selected != num}">
			                           			<a href="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}&?curPage=${num}">
			                           ...
			                           <c:choose>
			                               	<c:when test = "${curPage != totalPage }">
			                               		<a href="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}&?curPage=${curPage+1}">
			                               			<span class="page">
			                     		...
			                     		<c:choose>
			                               	<c:when test = "${curPage != totalPage }">
			                               		<span class="page">
			                                   		<a href="${pageContext.request.contextPath}/article/article_list?menu_code=${menu_code}&?curPage=${totalPage}"><i class="fas fa-angle-double-right"></i></a>
			                               		</span>
			                             	</c:when>
			                             	<c:otherwise>
			                               		<span class="page">

							...
							<div class="page-wrap bg-white" style="padding: 20px 0;">
								<div class="title">
									<h3 class="font18 noto m-lr10" style="color:tomato;">
										<i class="fas fa-feather-alt"></i><span> 시스템 공지사항 상세보기</span>
									</h3>
								</div>
								<div class="board-insert p10">
									<form id="frm" name="frm" method="post" enctype="multipart/form-data" autocomplete="off">
										...
										<div class="btn-grp center m-t10">
				                        	<button type="button" onClick="location.href='${pageContext.request.contextPath}/notice/system_notice'" class="btn-red">목록보기</button>
										</div>
									</form>
								</div>
							</div>

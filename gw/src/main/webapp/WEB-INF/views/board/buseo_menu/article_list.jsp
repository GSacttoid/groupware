									...
									<div class="flex flex-justify">
										...
										<div class="">
											<form method="post" action="${pageContext.request.contextPath}/buseo_article/article_list">
												...
												onClick="location.href='${pageContext.request.contextPath}/buseo_article/buseo_article_insert?menu_code=${menu_code}'">게시글 작성</button>
											</form>
										</div>
									</div>
										...
										<c:forEach var="articleList" items="${list}" varStatus="status"> 
						                    <tr class="center font14">
						                        ...
						                        <c:forEach begin="1" end="${articleList.re_level}">
						                            ...
						                            <a href="${pageContext.request.contextPath}/buseo_article/buseo_article_view?menu_code=${menu_code}&aid=${articleList.aid}" class="under weight700">${articleList.subject}</a>
...
$("#articleDeleteAll").click(function() {
    ...
    if( str ) {
        ...
        $.ajax({
        	type : "POST",
        	url : "${pageContext.request.contextPath}/buseo_article/buseo_article_delete_all",
        	data : { 
        		chkArr : chkArr,
        		boardArr : boardArr,
        		menu_code : menu_code

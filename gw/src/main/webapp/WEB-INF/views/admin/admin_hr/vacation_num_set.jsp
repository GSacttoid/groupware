				...
				<div class="main-wrap noto font14" style="width: 100%;">
					...
					<div class="p10">
						<div class="notice-title font16 noto">
							<h3>
								<i class="fas fa-info-circle m-lr5"></i>휴가일수 설정
							</h3>
						</div>
						<hr />
						<table
							style="width: 100%; border: 1px solid #c1c1c1; margin-bottom: 5px;">
							<tr>
								<td style="width: 20%; line-height: 1.8; padding: 10px;">
									<div class="noto font14">
										<ul>
											<li>직원별로 휴가일수를 관리할수 있으며, 휴가일수를 설정하면 직원들의 휴가 사용현황을 집계 관리할
												수 있다.</li>
										</ul>
									</div>
								</td>
							...
							<div class="td-50 m-lr5" style="width: 50%;">
								...
								<form method="post" action="#">
									<div class="p10 m-t10" style="border: 1px solid #c1c1c1;">
										<div class="">
											<div class="noto font16 weight700 m-tb10">2. 직급별 휴가일수
												설정</div>
										</div>
										<div class="">
											<table
												...
												<tr class="center noto font14">
													<td>1</td>
													<td>대표이사</td>
													<td><input type="text" class="input-135" name="" /> <span
														class="font14 noto" style="line-height: 35px;">일</span></td>
												</tr>
												<tr class="center noto font14">
													<td>2</td>
													<td>전무이사</td>
									...
									<div class="">
										<div class="m-b5">
											<form method="post" action="#">
												...
												</select> <input type="text" name="words" style="margin-left: -2px;" />
										...
										<table class="list"
											...
											<tr class="center noto font14">
												...
												<td>15</td>
												<td>
													<button type="button" class="list-btn m-lr5">휴가현황
														상세</button>
												</td>
											</tr>

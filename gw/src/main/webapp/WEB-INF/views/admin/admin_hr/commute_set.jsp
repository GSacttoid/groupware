                    ...
                    <div class="p20">
                        ...
                        <form method="post" action="#">
                            <div class="p10" style="border: 1px solid #c1c1c1;">
                            	<div class="noto font16 weight700 m-tb10">1. 출퇴근 시간 설정하기</div>
                                <table style="width:100%; border: 1px solid #c1c1c1; margin-bottom: 10px;">
                                        ...
                                        <tr class="m-t10 p10">
                                            ...
                                            <td class="flex">
                                                <select class="sel-attend" style="margin-left: 5px;">
                                                    <option>--시--</option>
                                                ...
                                                <p class="font16 noto weight700 m-lr5">시</p>
                                                ...
                                                <p class="font16 noto weight700" style="margin-left: 5px;">분</p>
                                            </td>
                                        </tr>
                        ...
                        <form method="post" action="#">
                            <div class="p10" style="border: 1px solid #c1c1c1;">
                                <div class="">
                                    <div class="noto font16 weight700 m-tb10">2. 출퇴근 체크 방법</div>

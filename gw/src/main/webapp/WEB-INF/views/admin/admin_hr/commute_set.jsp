    ...
    <div class="main-wrap noto font14" style="width:100%;">
        ...
        <div class="p20">
            <div class="notice-title font16 noto">
                <h3><i class="fas fa-info-circle m-lr5"></i>출퇴근 설정</h3>
            </div>
            <hr />
            ...
            <form method="post" action="#">
                <div class="p10" style="border: 1px solid #c1c1c1;">
                    ...
                    <table style="width:100%; border: 1px solid #c1c1c1; margin-bottom: 10px; margin-top:10px;">
                            <tr>
                                <td class="font14" style="width: 20%; text-align: center; background-color: #e2e2e2; padding: 10px;">현재 출퇴근 시간 설정</td>
                            ...
                            <tr class="m-t10 p10">
                                <td class="font14" style="width: 20%; text-align: center; background-color: #e2e2e2; padding: 10px;">출근 시간</td>
                                <td class="flex">
                                    <select class="sel-55" style="margin-left: 5px;">
                                        <option>--시--</option>
                                    ...
                                    <p class="font16 noto weight700 m-lr5" style="line-height:35px;">시</p>
                                    <select class="sel-55">
                                        <option>--분--</option>
                                    ...
                                    <p class="font16 noto weight700" style="margin-left: 5px; line-height:35px;">분</p>
                                </td>
                            </tr>

                            <tr class="m-t10">
                                <td class="font14" style="width: 20%; text-align: center; background-color: #e2e2e2; padding: 10px;">퇴근 시간</td>
                                <td class="flex">
                                    <select class="sel-55" style="margin-left: 5px;">
                                        <option>--시--</option>
                                        <option value="1">1</option>
            ...
            <form method="post" action="#">
                <div class="p10" style="border: 1px solid #c1c1c1;">
                    <div class="">
                        ...
                        <div class="noto font16 weight700 m-b10">사용중인 방법 : 사내 pc에서만 가능</div>
                    </div>
                    <div class="">

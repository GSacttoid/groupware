			                    ...
			                    <c:forEach var="noticeList" items="${list}" varStatus="status">
				                    <tr>
				                        ...
				                        <td>
				                        	...
				                        	onClick="location.href='${pageContext.request.contextPath}/admin/system_notice_view?sn_num=${noticeList.sn_num}'">${noticeList.sn_title}</div>
				                        </td>
				                        <td>${noticeList.sn_count}</td>
				                        <td>${noticeList.sn_maker}</td>
				                        <td>${noticeList.sn_regdate}</td>
				                        <td>
				                        	<button class="s-btn-on" id="modifyNotice" onClick="location.href='${pageContext.request.contextPath}/admin/system_notice_modify?sn_num=${noticeList.sn_num}'">수정</button>
...
<script>
    ...
    function noticeInsertOne(){
   	 ...
   	 var url 	="${pageContext.request.contextPath}/admin/system_notice_insert";
   	 var nick	="notice";
    ...
    function noticeDelete(sn_num) {
        ...
        if( str ) {   
            $.ajax({
            	url 	: "${pageContext.request.contextPath}/admin/system_notice_delete",
            	type 	: "POST", 	
            	data 	: { sn_num : sn_num },

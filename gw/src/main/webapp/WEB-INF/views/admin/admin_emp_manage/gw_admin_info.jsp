                 ...
                 <div class="p10" style="border: 1px solid #c1c1c1;">
                     ...
                     <table style="width:100%; border: 1px solid #c1c1c1; margin-bottom: 10px;">
                         <tr class="m-t10">
                             ...
                             <td class="p10" >
                                 <div class="flex">
                                     <label class="noto font14 weight700 m-lr10"><input type="radio" name="menu-admin" value="" style="margin: 4px;"  />전체 관리자</label>
                                     <label class="noto font14 weight700 m-lr10"><input type="radio" name="menu-admin" value="" style="margin: 4px;"  />회사메뉴 관리자</label>
                                     <label class="noto font14 weight700 m-lr10"><input type="radio" name="menu-admin" value="" style="margin: 4px;"  />부서메뉴 관리자</label>
                                 </div>
                             </td>
                         </tr>
                         <tr class="">

								...
								<td style="width: 20%; line-height: 1.8; padding: 10px;">
									<div class="noto font14">
										<ul>
											...
											<li>삭제된 회원은 복구가 불가능하지만, 퇴사처리된 회원은 다시 일반회원으로 변경되며 기본데이터들은
												삭제되지 않습니다.</li>
										</ul>
									</div>
								</td>
							...
							<div class="p10" style="border: 1px solid #c1c1c1;">
								<div class="">
									<div class="flex m-b10">
										...
										<div class="m-lr20">
											<button type="button" class="list-btn m-lr5"
												onclick="location.href='${pageContext.request.contextPath}/admin/gw_employee_waiting'">가입대기
												리스트</button>
											<button type="button" class="list-btn"
												onclick="location.href='${pageContext.request.contextPath}/admin/gw_employee_resign'">퇴사자
												리스트</button>
										</div>
									</div>
									...
									<div class="flex flex-justify">
										...
										<div class="">
											...
											<button type="submit" class="btn-off"
												style="margin-left: -2px;">직원 검색</button>
											<button type="button" class="btn-on"
												onClick="location.href='${pageContext.request.contextPath}/admin/gw_employee_register'">사원
												등록</button>
										</div>
									</div>
								</div>
										...
										<tr class="center noto font14">
											...
											<td>
												...
												<button type="button" class="s-btn-off"
													style="background-color: #fc6468; color: #fff;">퇴사</button>
											</td>
										</tr>
									</table>
								</div>

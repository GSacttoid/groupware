...
<div class="">
	<div class="title-detail"
		style="font-size: 14px; border-bottom: 1px solid #6d6d6d;">
		<h2>
			<a href="${pageContext.request.contextPath}/admin/main" title="관리자메뉴" class="f6"><i
				class="fab fa-codepen m-lr5"></i>관리자 메뉴</a>
		</h2>
	</div>

	<div id="" class="flex flex-justify">
		<a href="#" class="tab active-all" id="close">전체닫기</a> <a href="#"
			class="tab" id="open">전체열기</a>
	</div>
</div>
...
<div class="accordion">
	...
	<div class="accordion-content">
		<div>
			<a href="${pageContext.request.contextPath}/admin/company_notice">공지 사항</a>
		</div>
		<div>
			<a href="${pageContext.request.contextPath}/admin/survey_main">설문 조사</a>
		</div>
		<div>
			<a href="${pageContext.request.contextPath}/admin/menu_company_set">회사 메뉴 관리</a>
		</div>
		<div>
			<a href="${pageContext.request.contextPath}/admin/menu_buseo_set">부서 메뉴 관리</a>
		</div>
	</div>
	...
	<div class="accordion-content">
		<div>
			<a href="${pageContext.request.contextPath}/admin/workday_set">근무일 설정</a>
		</div>
		<div>
	...
	<div class="accordion-content">
		<div>
			<a href="${pageContext.request.contextPath}/admin/approval_set">전자결재 카테고리 설정</a>
		</div>
		<div>
			<a href="${pageContext.request.contextPath}/admin/approval_form">전자결재 양식관리</a>
		</div>
		<div>
			<a href="${pageContext.request.contextPath}/admin/approval_set">전자결재 설정관리</a>
		</div>
	</div>
	...
	<div class="accordion-content">
		<div>
			<a href="${pageContext.request.contextPath}/admin/gw_library_set">자료게시판 설정</a>
		</div>
	</div>
